...
<!-- One concern per PR. Title follows Conventional Commits, e.g. `fix: clear path when player unavailable`. -->
...
- [ ] Verified in the dev client by a human (which steps of the Rotation were exercised?)
