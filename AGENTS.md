...
4. **Build green.** `./gradlew build` runs compile, checkstyle and tests; done means zero violations and zero failures.
5. **Deploy** with `./dev.sh` (details and one-time setup: `docs/DEV-LOOP.md`).
